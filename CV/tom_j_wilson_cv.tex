...
\item Awarded STFC grant
\end{itemize}
\vspace{-10pt}
{\sl Postdoctoral Researcher}, Space Telescope Science Institute, 2018-2019
\begin{itemize}[noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt]
\item Analysis and optimisation of supernovae survey for future WFIRST observing strategies
...
\item Awarded STFC PhD Studentship
\end{itemize}
\vspace{-10pt}
...
\begin{itemize}[noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt]
\item Code for simulations of WFIRST supernovae lightcurves and characterisation efficiency
...
Bradley L., Sip\H{o}cz B., Robitaille T., Tollerud E., Vinícius Z., Deil C., Barbary K., Wilson T. J., et al, 2019, 10.5281/zenodo.3568287; ``astropy/photutils: v0.7, v0.7,1, v0.7.2''\vspace{2pt}\\
